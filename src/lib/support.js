// GENERATED build artifact of the DC runtime (from dc-runtime/src/*.ts) — do not edit by hand.
// The dc-runtime source is NOT part of this repository, so this file cannot be rebuilt here;
// it is vendored as-is. Replace it wholesale with a newer build rather than patching it.
// Note: COMPONENT_DIR is baked in as ".", so <dc-import> always fetches "./<Name>.dc.html".
// Pages remap those URLs via window.__resources — see the <head> of any page.
"use strict";
(() => {
